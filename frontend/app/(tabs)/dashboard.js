  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cardWide}>
        ...
        <Text style={styles.alertMeta}>{latest.cameraName} · {latest.timeAgo || latest.createdAt}</Text>
        <View style={styles.statusRow}>
          <Pill label={`${t('statusLabel')}: ${latest.status}`} tone={latest.status === 'resolved' ? 'success' : 'warning'} />
        </View>
        <Link href="/(tabs)/alerts" style={styles.link}>{t('seeAllAlerts')} →</Link>
      </View>
      ...
      <View style={styles.cardWide}>
        ...
        <Link href="/(tabs)/camera" style={styles.link}>{t('openCamera')} →</Link>
      </View>

      <Link href="/(tabs)/profile" style={styles.link}>{t('profileLink')}</Link>
    </View>
  );
}
